...
namespace Kaliber3D.Render
{
    ...
    public class Editor : ObservableObject
    {
        ...
        /// <summary>
        /// Removes the Container specified object from the Container.Layers collection.
        /// </summary>
        public void RemoveCurrentLayer(string name = null)
        {
            if (_project == null || _project.CurrentContainer == null)
                return;

            var layer = _project.CurrentContainer.Layers.FirstOrDefault(s => s.Name == name);
            if (layer == null)
                return;
